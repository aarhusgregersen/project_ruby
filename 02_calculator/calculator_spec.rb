...
describe "multiply" do
  ...
  it "multiples another multiple numbers" do 
    multiply(4,3,6,4).should == 288
  end

  it "multiplies another set of tons of numbers" do
    multiply(5,5,5,3,2,9,6,5).should == 202500
  end
